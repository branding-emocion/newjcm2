...
const projectsData = [
  {
    id: "golf-view",
    title: "Golf View",
    location: "Av. Huamán 830, Victor Larco",
    status: "En venta",
    delivery: "Consultar",
    price: "Consultar precio",
    description:
      "Exclusivo edificio residencial con departamentos de 2 y 3 dormitorios, estructura antisísmica, áreas comunes y excelente ubicación.",
    features: [
      "2-3 dormitorios",
      "71-157 m²",
      "Estacionamientos",
    ...
    mainVideo: "https://jcmconstrucciones.com/Videos/golf/SALAVERTICAL.mp4",
    thumbnails: [
      {
        video: "https://jcmconstrucciones.com/Videos/golf/SALAVERTICAL.mp4",
        label: "Sala",
      },
      {
        video: "https://jcmconstrucciones.com/Videos/golf/COCINAVERTICAL.mp4",
        label: "Cocina",
      },
      {
        video: "https://jcmconstrucciones.com/Videos/golf/COMEDORVERTICAL.mp4",
        label: "Comedor",
      },
      {
        video: "https://jcmconstrucciones.com/Videos/golf/BALCONVERTICAL.mp4",
        label: "Balcón",
      },
      {
        video: "https://jcmconstrucciones.com/Videos/golf/BAÑOVERTICAL.mp4",
        label: "Baño",
      },
      {
        video: "https://jcmconstrucciones.com/Videos/golf/LOBBYVERTICAL.mp4",
        label: "Lobby",
      },
    ],
    link: "/Proyecto/goAZWLdsaJro3tGCSOih",
    brochureLink:
      "https://firebasestorage.googleapis.com/v0/b/alva-inmobiliario.appspot.com/o/proyectos%2FgoAZWLdsaJro3tGCSOih%2Fbrochure.pdf?alt=media&token=e218080d-3a82-4147-a997-1d4b5e9ee51c",
    tour3DLink: "https://bit.ly/EDIFICIO3DGOLFVIEW",
    contactPhone: "947 455 553",
  },
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="w-24 h-1 bg-[] mx-auto mt-6"></div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative">
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-lg bg-gray-900">
              <video
                ...
                poster="/placeholder.svg?key=bc5lo"
              ...
              <div className="absolute top-4 left-4 pointer-events-none">
                <span className="bg-[] text-white px-4 py-1 text-sm font-medium rounded-sm">
                  {project.status}
                </span>
              </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <Button asChild className="flex-1 bg-[] hover:bg-blue-700">
        ...
        <div className="flex justify-between items-center mt-8">
          <button
            onClick={prevProject}
            className="flex items-center text-gray-600 hover: transition-colors"
          >
          ...
          <button
            onClick={nextProject}
            className="flex items-center text-gray-600 hover:text-[] transition-colors"
          >
        ...
        >
          <Link
            ...
            className="inline-flex items-center text-[] hover:text-blue-800 font-medium transition-colors"
          >

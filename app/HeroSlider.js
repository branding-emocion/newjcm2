...
const sliderData = [
  {
    ...
    videoUrl: "https://jcmconstrucciones.com/Videos/golf/GOLFVIEW.mp4", // Reemplazar con URL real
  },
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12 text-white">
                ...
                >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-6 py-3 bg-[#193148] hover:bg-blue-700 text-white font-medium rounded-md transition-colors"
                  >
                    Ver Proyecto
              ...
              <div className="relative w-full h-full">
                ...
                >
                  <button
                    ...
                    className="flex items-center justify-center w-20 h-20 bg-[#193148] hover:bg-blue-700 rounded-full transition-colors"
                    aria-label={
